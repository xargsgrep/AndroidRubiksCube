...
public class Square {
	...
	private void glApplyColor(GL10 gl, Color color) {
		switch (color) {
			case WHITE:
				gl.glColor4f(ONE_F, ONE_F, ONE_F, ZERO_F); break;
			case YELLOW:
				gl.glColor4f(ONE_F, ONE_F, ZERO_F, ZERO_F); break;
			case GREEN:
				gl.glColor4f(ZERO_F, ONE_F, ZERO_F, ZERO_F); break;
			case ORANGE:
				gl.glColor4f(ONE_F, ONE_F/2, ZERO_F, ZERO_F); break;
			case BLUE:
				gl.glColor4f(ZERO_F, ZERO_F, ONE_F, ZERO_F); break;
			case RED:
				gl.glColor4f(ONE_F, ZERO_F, ZERO_F, ZERO_F); break;
		}
	}
